...
public class HourlyEmployee extends Employee{
        ...
        public HourlyEmployee(String firstName, String lastName, String socialSecurityNumber,int month,int day, int year){
            ...
            if((hours < 0.0)||(hours >168.0))
                ...
                throw new IllegalArgumentException("Hourly worked must be >= 0.0 and <= 168.0");
